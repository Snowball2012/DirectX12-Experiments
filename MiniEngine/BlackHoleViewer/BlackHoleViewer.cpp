...
#include "CompiledShaders/BlackHoleViewerVS.h"
#include "CompiledShaders/BlackHoleViewerPS.h"
#ifdef _WAVE_OP
#include "CompiledShaders/BlackHoleViewerVS_SM6.h"
#include "CompiledShaders/BlackHoleViewerPS_SM6.h"
#endif
...
class BlackHoleViewer : public GameCore::IGameApp
{
public:
...
CREATE_APPLICATION( BlackHoleViewer )
...
void BlackHoleViewer::Startup( void )
{
	m_RootSig.Reset(4, 2);
	...
	m_RootSig.Finalize(L"BlackHoleViewer", D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT);
	...
	m_ModelPSO.SetVertexShader( g_pBlackHoleViewerVS, sizeof(g_pBlackHoleViewerVS) );
	m_ModelPSO.SetPixelShader( g_pBlackHoleViewerPS, sizeof(g_pBlackHoleViewerPS) );
	m_ModelPSO.Finalize();

#ifdef _WAVE_OP
	m_ModelWaveOpsPSO = m_ModelPSO;
	m_ModelWaveOpsPSO.SetVertexShader( g_pBlackHoleViewerVS_SM6, sizeof(g_pBlackHoleViewerVS_SM6) );
	m_ModelWaveOpsPSO.SetPixelShader( g_pBlackHoleViewerPS_SM6, sizeof(g_pBlackHoleViewerPS_SM6) );
...
void BlackHoleViewer::Cleanup( void )
{
	m_Model.Clear();
...
void BlackHoleViewer::Update( float deltaT )
{
...
void BlackHoleViewer::RenderObjects( GraphicsContext& gfxContext, const Matrix4& ViewProjMat, eObjectFilter Filter )
{
	struct VSConstants
	{
...
void BlackHoleViewer::RenderLightShadows(GraphicsContext& gfxContext)
{
...
void BlackHoleViewer::RenderScene( void )
{
...
void BlackHoleViewer::CreateParticleEffects()
{
